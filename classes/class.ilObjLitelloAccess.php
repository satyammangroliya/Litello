...
/**
 * Class ilObjLitelloAccess
 *
 *
 * @author Minervis GmbH <jephte.abijuru@minervis.com>
 */
class ilObjLitelloAccess extends ilObjectPluginAccess
{
    ...
    /**
     * ilObjLitelloAccess constructor
     */
    ...
    {
        $object_settings = self::litello()->objectSettings()->getObjectSettingsById(intval($a_obj_id));
    ...
    {
        ilUtil::sendFailure(self::plugin()->translate("permission_denied", ilObjLitelloGUI::LANG_MODULE_OBJECT), true);
