...
namespace srag\DIC\Litello;

use ilLogLevel;
use ilPlugin;
use srag\DIC\Litello\DIC\DICInterface;
use srag\DIC\Litello\DIC\Implementation\ILIAS54DIC;
use srag\DIC\Litello\DIC\Implementation\ILIAS60DIC;
use srag\DIC\Litello\Exception\DICException;
use srag\DIC\Litello\Output\Output;
use srag\DIC\Litello\Output\OutputInterface;
use srag\DIC\Litello\Plugin\Plugin;
use srag\DIC\Litello\Plugin\PluginInterface;
use srag\DIC\Litello\Version\Version;
use srag\DIC\Litello\Version\VersionInterface;

/**
 * Class DICStatic
 *
 * @package srag\DIC\Litello
 */
